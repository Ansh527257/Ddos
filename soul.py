...
bot = telebot.TeleBot('7420338334:AAHQSAYyhQhxD1o9uW2qjlJpNNNW1TLhZbo')
...
def show_plan(message):
   ...
   # response += "- Pro Plan: $20/month\n"
    ...
    response = "- Know our services from @ZENIN_OWNERX\n"
...
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/GOKU_MODS'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/ZENIN_OWNERX')
    )
